...
То есть **системные вызовы** выполняют те рутинные действия, которые осуществлялись раньше вручную, — загрузка кода программы в память, передача его на исполнение процессору и прочее.
